import type { ExamDashboardStatCard, ExamDashboardHeader } from './types'

export const examDashboardStatCardData: ExamDashboardStatCard[] = [
...
export const examDashboardHeaderData: ExamDashboardHeader = {
