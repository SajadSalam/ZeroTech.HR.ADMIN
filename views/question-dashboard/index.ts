import type { QuestionDashboardStatCard, QuestionDashboardHeader } from './types'

export const questionDashboardStatCardData: QuestionDashboardStatCard[] = [
...
export const questionDashboardHeaderData: QuestionDashboardHeader = {
