...
import type { ImportQuestionResponse } from '~/views/question-bank/service'
...
const importQuestions = async () => {
    ...
    try {
        ...
        // const selectedQuestionTypeOption = importQuestionTypeOptions(t).find(x => x.value === selectedQuestionType.value?.value) as ImportQuestionTypeOption
        const selectedQuestionTypeOption = importQuestionTypeOptions(t).find(x => x.value === selectedQuestionType.value)
