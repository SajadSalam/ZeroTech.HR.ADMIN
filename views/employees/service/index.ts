...
interface IEmployeeService {
  ...
  update: (id: string | number, data: EmployeeUpdateDto) => Promise<EmployeeDto>
...
export class EmployeeService implements IEmployeeService {
  ...
  async get(filters: EmployeeFilters): Promise<PaginatedResponse<EmployeeDto>> {
    try {
  ...
  async update(id: string | number, data: EmployeeUpdateDto): Promise<EmployeeDto> {
    try {
