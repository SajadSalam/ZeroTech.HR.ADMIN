...
<template>
  <div>
    ...
    >
      ...
      <div class="pa-4 flex flex-col justify-between gap-4 text-white">
        ...
        <div>
          ...
          <h5 class="my-5">{{ $t('ems') }}</h5>
        </div>
      </div>
      <img :src="LoginImage" class="absolute -z-10 size-full object-cover brightness-50" >
    </div>
  </div>
</template>
