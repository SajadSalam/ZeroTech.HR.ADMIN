<template>
  ...
  >
    ...
    <path fill="currentColor" d="M196.8 79.6H616v419.7H196.8z" clip-path="url(#d)" />
    ...
    <path fill="currentColor" d="M674.2 88.2h103.2v402.5H674.2z" clip-path="url(#f)" />
    <defs>
      <path
        id="g"
    ...
    <path fill="currentColor" d="M834.8 63.9h212.6v426.7H834.8z" clip-path="url(#h)" />
    <defs>
      <path
        id="i"
    ...
    <path fill="currentColor" d="M1059.4 78h422v422h-422z" clip-path="url(#j)" />
    <defs>
      <path
        id="k"
    ...
    <path fill="currentColor" d="M1393 0h131.6v131.6H1393z" clip-path="url(#l)" />
  </svg>
</template>
