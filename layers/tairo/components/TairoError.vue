    ...
    <DevOnly>
      <div v-if="showStackTrace">
        <BaseCard
          v-focus
          rounded="lg"
          class="group nui-focus relative mx-auto mt-6 max-w-3xl border-2 border-dashed p-8 nui-text-700 hover:border-solid"
          tabindex="0"
        >
          <div
          ...
          >
            ...
            <BaseTag v-if="props.error.url" color="danger" variant="outline" size="sm">
              {{ props.error.url }}
            </BaseTag>
          </div>
          <div class="mb-4 flex items-center gap-2">
            ...
            <div>
              <h4 class="font-mono text-lg font-medium text-danger-500 [overflow-wrap:anywhere]">
                {{ props.error.message }}
              </h4>
              <p class="text-xs font-medium nui-text-500">
