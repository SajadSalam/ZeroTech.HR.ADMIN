...
<template>
  <Popover>
    <Float
      ...
      :z-index="20"
    >
      <PopoverButton class="group inline-flex cursor-pointer focus:outline-none" as="div">
        <slot />
      </PopoverButton>
      ...
      >
        <FocusTrap>
          <div
            class="relative w-full rounded-lg border border-muted-200 bg-white shadow-xl shadow-muted-300/30 after:absolute after:-top-2 after:size-4 after:rotate-[-135deg] after:border-b after:border-r after:border-muted-200 after:bg-white after:content-[''] dark:border-muted-600 dark:bg-muted-700 dark:shadow-muted-800/20 dark:after:border-muted-600 dark:after:bg-muted-700"
            :class="[
