    ...
    >
      ...
      <slot name="right">
        <div class="w-full sm:w-auto">
          <div
            class="relative flex h-9 w-full bg-white dark:bg-muted-800 sm:w-40"
            :class="[
          ...
          >
            <button
              type="button"
              class="nui-focus relative z-10 flex flex-1 cursor-pointer items-center justify-center text-sm transition-colors duration-300"
              :class="[
            ...
            <div
              class="absolute start-0 top-0 h-full w-1/2 bg-primary-500 transition-all duration-300 ease-in-out"
              :class="[
