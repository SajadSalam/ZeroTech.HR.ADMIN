...
<template>
  <div
    class="before: flex items-center justify-between p-5 font-alt text-sm before:text-xs before:font-medium before:uppercase before:text-muted-400 before:content-[attr(data-content)] md:justify-start md:p-4 md:before:hidden"
    :class="[
