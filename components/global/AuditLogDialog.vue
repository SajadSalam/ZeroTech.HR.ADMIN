    ...
    <div class="rounded-3xl p-3">
      <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-2">
           <div v-if="auditLogs.length > 0 && !isLoading" class="bg-white rounded-2xl px-6 py-2 max-h-[560px] overflow-y-auto">
    <div v-for="(log, index) in auditLogs" :key="log.id" class="flex flex-row gap-4">
      <div class="flex flex-col items-center">
        ...
        <div
          ...
          class="flex-1 min-h-[20px] w-[2px] bg-gray-200"
        />
      </div>
      ...
      <div class="flex-1 pb-6 ">
        <div class="text-sm text-gray-800">
          ...
          <span class="font-semibold capitalize mr-1">
            {{ auditLogActions[log.action].name }}
          </span>
          <span class="ml-1">
            {{  }}
          </span>
