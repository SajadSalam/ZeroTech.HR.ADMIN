...
<template>
  <div class="nui-pagination my-2" :class="[
    ...
    <BaseFocusLoop class="nui-pagination-buttons" :class="[rounded && radiuses[rounded], props.classes?.buttons]">
      <slot name="before-navigation"></slot>

      <!-- Previous -->
      <NuxtLink :to="paginatedLink(currentPage - 1)" tabindex="0" class="nui-pagination-button"
