        ...
        <AppCrud hide-create title="سجلات الحضور">
            ...
            <template #headerActions>
                <BaseButton color="success" variant="outline" class="gap-2" :loading="isLoading"
                    :disabled="selectedItemsID.length === 0" @click="handleProcessPayroll">
                    <Icon name="ph:currency-circle-dollar-duotone" class="size-5" />
                    معالجة الحضور للرواتب
                </BaseButton>
                <BaseButton color="success" variant="outline" class="gap-2" :loading="isLoading"
            ...
            <AppTable v-model:selected-items-id="selectedItemsID" has-select title="قائمة سجلات الحضور"
